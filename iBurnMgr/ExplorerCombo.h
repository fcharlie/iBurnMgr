...
public:
	...
	DECLARE_WND_SUPERCLASS(_T("Metro.AutoComplete.Native"), CComboBoxEx::GetWndClassName())
	...
	LRESULT OnCreate(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& /*bHandled*/)
	{
		...
		if(lRet != -1)
		{
			...
			m_tb = CFrameWindowImplBase<>::CreateSimpleToolBarCtrl(m_hWnd, 10086, FALSE, ATL_SIMPLE_TOOLBAR_PANE_STYLE | TBSTYLE_LIST);
